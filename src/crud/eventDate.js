...
function isValidEventDates(eventDates) {
    return (
      ...
      (typeof eventDates.title === 'string' || eventDates.title === null || eventDates.title === undefined) &&
      eventDates.date instanceof Date &&
      typeof eventDates.sequence === 'number' &&
      typeof eventDates.extended === 'boolean' &&
      (eventDates.newDate instanceof Date || eventDates.newDate === null || eventDates.newDate === undefined) &&
