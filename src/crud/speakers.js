...
function isValidSpeakers(speakers) {
    return (
      ...
      (typeof speakers.ImgLink === 'string' || speakers.ImgLink === null || speakers.ImgLink === undefined) &&
      typeof speakers.TalkType === 'string' &&
      typeof speakers.TalkTitle === 'string' &&
      (typeof speakers.Abstract === 'string' || speakers.Abstract === null || speakers.Abstract === undefined) &&
      (typeof speakers.Bio === 'string' || speakers.Bio === null || speakers.Bio === undefined) &&
